...
!function (b) {
    ...
    h.prototype = {
        constructor: h, get: function (a, b) {
    ...
    k.prototype = {
        constructor: k, init: function (a, c, d, e) {
            this.type = a;
            this.$element = b(c);
        ...
        destroy: function () {
            ...
            for (var c = "", d = a.is("input[type=checkbox]"), e = a; e.length;) {
                ...
                var f = a.nodeName;
                if (!f)break;
                var f = f.toLowerCase(), e = e.parent(), g = e.children(f);
                if (b(a).is("form, input, select, textarea") ||
                    d)if (f += b(a).attr("name") ? "." + b(a).attr("name") : "", 1 < g.length && !b(a).is("input[type=radio]") && (f += ":eq(" + g.index(a) + ")"), c = f + (c ? ">" + c : ""), "form" == a.nodeName.toLowerCase())break
            }
    ...
    b.fn.garlic = function (a, c) {
        function d(c) {
            var d = b(c), g = d.data("garlic"), h = b.extend({}, e, d.data());
            if (("undefined" === typeof h.storage || h.storage) && "password" !== b(c).attr("type"))if (g || d.data("garlic",
                    g = new k(c, f, h)), "string" === typeof a && "function" === typeof g[a])return g[a]()
        }

        var e = b.extend(!0, {}, b.fn.garlic.defaults, a, this.data()), f = new h, g = !1;
